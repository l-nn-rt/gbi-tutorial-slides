...
% @todo hier neue regel einfügen
\begin{frame}{Übungsblätter}
	\begin{itemize}
		\item \textbf{Ausgabe}: Dienstags im \ILIAS \\
			  \hstretchto{\textbf{Ausgabe}:}{\textbf{Abgabe}:} Freitag (10 Tage später), 12:30~Uhr, im GBI-Kasten im U-Geschoss des Infobaus
		\pause
		\begin{block}{Frage}
...
\begin{frame}{Fragen? Hilfe?}	
	\begin{block}{Fragen}
		\begin{itemize}
			...
			\pause
			\item Organisatorischer Spezialkram? \impl an Kern/Ulbrich (\mailto{philipp.kern@kit.edu} / \mailto{ulbrich@kit.edu}) \\
...
\begin{frame}{Eselsbrücke}

	\includegraphics{mengen/rock.jpeg}
