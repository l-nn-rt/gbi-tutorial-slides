...
\begin{frame}{Übungsblätter}
	\begin{itemize}
		\item \textbf{Ausgabe}: Freitags im \ILIAS \\
			  \hstretchto{\textbf{Ausgabe}:}{\textbf{Abgabe}:} Freitag (7 Tage später), 12:30~Uhr, im GBI-Kasten im U-Geschoss des Infobaus
		\pause
		...
		\item Übungslätter \textbf{7-12 alleine!} (sonst \textbf{Übungsschein weg}!)
