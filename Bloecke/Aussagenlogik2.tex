...
\begin{frame}{Lösung}
	\begin{prooftree}
		...
		\RightLabel{\rulename{$\aland$I}}
		\BinaryInf $\alP, \alQ \fCenter \alP \aland \alQ$

		\RightLabel{\rulename{$\aland$E$_l$}}
		\UnaryInf $\alP, \alQ \fCenter \alP$

		\RightLabel{\rulename{$\alimpl$I}}
...
\begin{frame}{Lösung}
	\begin{prooftree}
		...
		\AxiomC{$~$}
		\RightLabel{\rulename{Ax}}
		\UnaryInf $\alP \fCenter \alP$
		\RightLabel{\rulename{$\alor$I$_l$}}
		\UnaryInf $\alP \fCenter \alP \alor \alP$

		\def\fCenter{\mbox{~~$\alimpl$~~}}
		\RightLabel{\rulename{$\alimpl$I}}
		\UnaryInf $\alP \fCenter \alP \alor \alP$
	\end{prooftree}
	...
	\begin{prooftree}
		...
		\AxiomC{$~$}
		\RightLabel{\rulename{Ax}}
		\UnaryInf $\alP \alor \alP \fCenter \alP \alor \alP$
		...
		\def\fCenter{\mbox{~~$\alvdash$~~}}
		\RightLabel{\rulename{$\alor$E}}
		\TrinaryInf $\alP \alor \alP \fCenter \alP$

		\def\fCenter{\mbox{~~$\alimpl$~~}}
		\RightLabel{\rulename{$\alimpl$I}}
		\UnaryInf $\alP \alor \alP \fCenter \alP$
	\end{prooftree}
\end{frame}
