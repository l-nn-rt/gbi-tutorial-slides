...
\begin{frame}[t]{Auswertung}
	\only<all:1>{\includegraphics[scale=0.65]{aussagenlogik/al_uebung_1}\\[2em]
	Quelle: GBI-Übung 2015/2016}
	\only<all:2>{\includegraphics[scale=0.6]{aussagenlogik/al_uebung_2}}
	\only<all:3>{\includegraphics[scale=0.6]{aussagenlogik/al_uebung_3}}
	\only<all:4>{\includegraphics[scale=0.6]{aussagenlogik/al_uebung_4}}
	\only<all:5>{\includegraphics[scale=0.6]{aussagenlogik/al_uebung_5}}
\end{frame}
