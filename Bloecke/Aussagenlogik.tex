...
\begin{frame}[t]{Auswertung}
	...
	\only<all:2>{\includegraphics[scale=0.6]{al_uebung_2}}
	\only<all:3>{\includegraphics[scale=0.6]{al_uebung_3}}
	\only<all:4>{\includegraphics[scale=0.6]{al_uebung_4}}
	\only<all:5>{\includegraphics[scale=0.6]{al_uebung_5}}
\end{frame}
