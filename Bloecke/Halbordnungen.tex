...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.7]{halbordnungen/Halbordnung.pdf}
	\end{figure} \pause
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.6]{halbordnungen/Hasse1.pdf}
\end{figure} \pause
...
\begin{frame}
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.7]{halbordnungen/Loesung.pdf}
	\end{figure}
\end{frame}