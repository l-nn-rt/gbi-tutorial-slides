...
\begin{frame}{MIMA}
    \centering
	\includegraphics[width=.82\linewidth]{MIMA_simple.png}\\
...
\begin{frame}{Eigenschaften}
	\begin{itemize}[<+->]
		...
		\begin{itemize}
			...
			\item[]<+(-2)-> \includegraphics[width=150px]{MIMA_commands.png} 
		\end{itemize} 
	\end{itemize}
\end{frame}
...
\begin{frame}[t]{Aufbau}
	\begin{figure}
		\centering
		\includegraphics[width=.82\linewidth]{MIMA.png}
	\end{figure}
\end{frame}
...
\begin{frame}[t]{Befehlsholphase}
	\begin{figure}
		\centering
		\includegraphics[width=.7\linewidth]{MIMA.png}
	\end{figure}
	\pause
...
\begin{frame}{Bemerkungen}
	\begin{block}{Indirekte Adressierung (LDIV, STIV)}
		\centering
		\includegraphics[width=250px]{MIMA_indirect.png}
	\end{block}
